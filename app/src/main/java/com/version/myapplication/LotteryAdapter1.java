...
public class LotteryAdapter1 extends RecyclerView.Adapter<LotteryAdapter1.ViewHolder> {
    ...
    public LotteryAdapter1(Context context, int sun, IAddListListener listener) {
        mContext = context;
        this.sun = sun;
    ...
    private LotteryAdapter1.IAddListListener listener;//声明成员变量
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(new LotteryView(mContext, 2));
    }
