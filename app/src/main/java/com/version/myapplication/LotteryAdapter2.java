...
public class LotteryAdapter2 extends RecyclerView.Adapter<LotteryAdapter2.ViewHolder> {
    ...
    public String msg ="";
    private int sun;
    public LotteryAdapter2(Context context, int sun, IAddListListener listener) {
        mContext = context;
        this.sun = sun;
        this.listener = listener;
        initData();
    }
    private LotteryAdapter2.IAddListListener listener;//声明成员变量
...
this.holder = holder;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(new LotteryView(mContext,3));
    }
