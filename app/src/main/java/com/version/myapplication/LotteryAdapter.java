...
public class LotteryAdapter extends RecyclerView.Adapter<LotteryAdapter.ViewHolder> {
    ...
    public LotteryAdapter(Context context, int sun, IAddListListener listener) {
        mContext = context;
        this.sun = sun;
        this.listener = listener;
        initData();
    }
    private LotteryAdapter.IAddListListener listener;//声明成员变量
    ...
    LotteryAdapter.ViewHolder holder;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(new LotteryView(mContext,1));
    }
